...
import svgPathsFamily from "../imports/svg-ghjxphics1";
...
interface SaruComcenProps {
  onNavigate?: (tab: string) => void;
  onLogout?: () => void;
}

export default function SaruComcen({
  onNavigate,
  onLogout,
}: SaruComcenProps) {
        ...
        <div className="flex-1 flex flex-col gap-[20px] min-w-0">
          ...
          <div className="bg-white/80 border border-[rgba(103,103,103,0.3)] rounded-[30px] p-[24px]">
            <div className="flex items-center gap-4 mb-[24px]">
              ...
              <div>
                <div className="font-['Poppins',sans-serif] text-[28px] text-black leading-[28px] font-normal font-bold">
                  #{unit.id}
                </div>
