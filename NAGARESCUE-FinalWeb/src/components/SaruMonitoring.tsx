...
import svgPathsFamily from "../imports/svg-gw0b6p2p25";
...
export default function SaruMonitoring({
  ...
  const [expandedIncoming, setExpandedIncoming] =
    useState(false);
    ...
    <div className="relative w-full h-screen bg-white overflow-hidden">
      ...
      <div className="relative z-10 flex gap-[20px] px-[30px] pt-[28px] pb-[28px] h-[calc(100vh-80px)]">
        ...
        <div className="bg-white rounded-[10px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[280px] flex flex-col p-[24px]">
          <div className="font-['Poppins',sans-serif] font-bold text-[28px] text-black mb-[18px] leading-[32px]">
            S.A.R.U LIST
          </div>
          ...
          <div className="flex items-center justify-between mb-[15px]">
            ...
            <span className="font-['Poppins',sans-serif] text-[12px] text-[#00000080] flex items-center gap-[6px] before:content-[''] before:w-[8px] before:h-[8px] before:rounded-full before:bg-[#73D05E]">
              12 Active
            </span>
          </div>

          <div className="bg-[#dae7f8] flex items-center gap-[10px] px-[15px] h-[40px] rounded-[10px] shadow-[0px_1px_2.9px_0px_rgba(0,0,0,0.25)] mb-[18px]">
            ...
            {searchQuery && (
              <button
                className="bg-transparent mr-[5px]"
                ...
                >
                  <div className="flex items-center gap-3 mb-[10px]">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-['Poppins',sans-serif] font-bold text-[16px] text-black leading-[18px]">
                        #{unit.id}
                      </div>
                      <div className="font-['Poppins',sans-serif] text-[12px] text-[#00000080] leading-[16px]">
                        {unit.type}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-[12px] mb-[6px]">
                    ...
                    >
                      <path
                        d={svgPathsSaru.p33a9dd00}
                        fill="#000000"
                      />
                    </svg>
                    <span className="font-['Poppins',sans-serif] text-black">
                      {unit.crewMembers} Crew Members
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-[12px] mb-[6px]">
                    <svg
                    ...
                    >
                      <path
                        d={svgPathsSaru.p60bd380}
                        fill="#000000"
                      />
                    </svg>
                    <span className="font-['Poppins',sans-serif] text-black">
                      {unit.livesRescued} Lives Rescued
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-[12px]">
                    ...
                    >
                      <path
                        d={svgPathsSaru.p592ae00}
                        fill="#000000"
                      />
                    </svg>
                    <span className="font-['Poppins',sans-serif] text-black">
                      {unit.timeDeployed} Deployed
                    </span>
                  </div>
                  <div
        ...
        <div className="flex-1 flex flex-col gap-[20px] min-w-0">
          ...
          <div className="bg-white/80 border border-[rgba(103,103,103,0.3)] rounded-[30px] p-[24px]">
            <div className="flex items-center gap-4 mb-[24px]">
              ...
              <div>
                <div className="font-['Poppins',sans-serif] font-bold text-[28px] text-black leading-[28px]">
                  #{unit.id}
                </div>
                <div className="font-['Poppins',sans-serif] text-[16px] text-black leading-[20px]">
                  {unit.type}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-[18px]">
              <div className="bg-[#eeeeee] rounded-[20px] p-[16px]">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  >
                    <path
                      d={svgPathsSaru.p2a637b00}
                      fill={unit.statusColor}
                    />
                  </svg>
                  <span className="font-['Poppins',sans-serif] text-[13px] text-black">
                    Status
                  </span>
                </div>
          ...
          <div className="flex-1 grid grid-cols-2 gap-[20px] min-h-0">
            ...
            <div className="bg-white rounded-[15px] border border-[#8C000F] p-[20px] overflow-y-auto custom-scrollbar">
              <div className="font-['Poppins',sans-serif] font-bold text-[20px] text-black mb-[18px]">
                Ongoing Operations
              </div>
              ...
              <div className="bg-white rounded-[15px] border border-[#00000040] p-[18px]">
                <div className="flex items-start justify-between mb-[12px]">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <path
                        d={svgPathsFamily.p2593fe80}
                        fill="#5FC9F3"
                      />
                    </svg>
                    <div className="font-['Poppins',sans-serif] font-bold text-[18px] text-black leading-[20px]">
                      #H-123456
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="font-['Poppins',sans-serif] text-[11px] text-[#00000080] whitespace-nowrap">
                      12m ago
                    </span>
                    <button
                      onClick={() =>
                        setExpandedOngoing(!expandedOngoing)
                      }
        ...
        <div className="bg-white rounded-[10px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[280px] flex flex-col p-[24px]">
          <div className="font-['Poppins',sans-serif] font-bold text-[22px] text-black mb-[24px]">
            Crew & Equipment
          </div>

          <div className="mb-[28px]">
            <div className="font-['Poppins',sans-serif] font-bold text-[18px] text-black mb-[15px]">
              Crew Members
            </div>
            <div className="flex flex-col gap-[12px]">
              {unit.members.map((member, index) => (
                ...
                >
                  <span className="font-['Poppins',sans-serif] text-[14px] text-black leading-[18px] flex-1">
                    {member.name}
                  </span>
                  <span className="font-['Poppins',sans-serif] text-[12px] text-[#00000080] leading-[18px] whitespace-nowrap">
                    {member.role}
                  </span>
                </div>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-col gap-[10px]">
              <div className="flex justify-between items-center">
                ...
                <span className="font-['Poppins',sans-serif] font-bold text-[14px] text-black">
                  2
                </span>
              </div>
              <div className="flex justify-between items-center">
