import svgPaths from "./svg-ghjxphics1";

export default function MaterialSymbolsFamilyGroup() {
  return (
    <div className="relative size-full" data-name="material-symbols:family-group">
