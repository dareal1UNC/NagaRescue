import svgPaths from "./svg-d5n9ra9co5";
...
function Card({ text, text1, text2, text3, text4, additionalClassNames = "" }: CardProps) {
  return (
    <div className={clsx("absolute left-[16px] w-[257px]", additionalClassNames)}>
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[9px] leading-[8px] left-[65px] not-italic text-[10px] text-black top-[40px] w-[136px]">{text}</p>
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[9px] leading-[8px] left-[49px] not-italic text-[14px] text-black top-[62px] w-[119px]">{text1}</p>
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[9px] leading-[8px] left-[48px] not-italic text-[14px] text-black top-[84px] w-[119px]">{text2}</p>
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[9px] leading-[8px] left-[49px] not-italic text-[14px] text-black top-[107px] w-[119px]">{text3}</p>
      <HeartOutline />
      ...
      <div className="absolute flex flex-col font-['Poppins:Bold',sans-serif] h-[21px] justify-center leading-[0] left-[65px] not-italic text-[14px] text-black top-[25.5px] translate-y-[-50%] w-[117px]">
        <p className="leading-[8px]">{text4}</p>
      </div>
      <Text text="Stand By" />
    </div>
  );
...
function Equipment({ text, text1, text2, text3, text4, text5, additionalClassNames = "" }: EquipmentProps) {
  return (
    <div className={clsx("absolute content-stretch flex flex-col font-['Josefin_Sans:Medium',sans-serif] font-medium gap-[6px] items-start leading-[0] text-[#163b56] text-[20px] top-[726.23px]", additionalClassNames)}>
...
export default function Saru() {
  return (
    <div className="relative size-full" data-name="SARU">
      ...
      <div className="absolute flex flex-col font-['Poppins:SemiBold',sans-serif] justify-center leading-[0] left-[189.5px] not-italic text-[45px] text-black text-center text-nowrap top-[186px] translate-x-[-50%] translate-y-[-50%]">
      ...
      <div className="absolute h-[194px] left-[384px] top-[167px] w-[1008px]" data-name="Rescue Details">
        ...
        <div className="absolute h-[86px] left-[30px] top-[90px] w-[218px]" data-name="Card 1">
          <div className="absolute bg-[#eee] h-[86px] left-0 rounded-[20px] top-0 w-[174px]" />
              ...
              <div className="absolute inset-[0_0_-8.12%_0]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 22">
                  <g id="Group 8">
                    ...
                    <g clipPath="url(#clip0_49_836)" id="heroicons:map-pin-16-solid">
                      <path clipRule="evenodd" d={svgPaths.p3faa80c0} fill="var(--fill-0, #FE4848)" fillRule="evenodd" id="Vector" />
                    </g>
                    <g clipPath="url(#clip1_49_836)" id="EC 4">
      ...
      <div className="absolute contents left-[1032px] top-[376px]" data-name="Crew and Equipment">
        <div className="absolute bg-white border border-[rgba(81,81,81,0.5)] border-solid h-[622.16px] left-[1032px] rounded-[20px] top-[376px] w-[360px]" />
        <div className="absolute flex flex-col font-['Poppins:Medium',sans-serif] h-[29.816px] justify-center leading-[0] left-[1057px] not-italic text-[16px] text-black top-[407.91px] translate-y-[-50%] w-[217px]">
          <p className="leading-[8px]">{`Crew & Equipment`}</p>
        </div>
        <div className="absolute flex flex-col font-['Josefin_Sans:Bold',sans-serif] font-bold h-[29.816px] justify-center leading-[0] left-[1057px] text-[25px] text-black top-[698.14px] translate-y-[-50%] w-[150px]">
          <p className="leading-[35px]">Equipment</p>
        </div>
        <div className="absolute h-[154.46px] left-[1057px] top-[442.23px] w-[309px]" data-name="CREW MEMBER">
        ...
        <Equipment text="Portable Boat" text1="Rope" text2="Chainsaw" text3="Medic Kit" text4="Entonox" text5="Rigging System" additionalClassNames="left-[1068px] w-[156px]" />
        <Equipment text="2" text1="5" text2="2" text3="4" text4="2" text5="1" additionalClassNames="left-[1238px] w-[116px]" />
        <Add additionalClassNames="left-[1321px] top-[618px]" />
        <Add additionalClassNames="left-[1320px] top-[929px]" />
      </div>
        ...
        <div className="absolute contents left-[93px] top-[20px]" data-name="BADGE">
          <div className="absolute left-[93px] size-[65px] top-[20px]" data-name="material-symbols:emergency-share-outline-rounded">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 65 65">
              <g filter="url(#filter0_i_49_864)" id="material-symbols:emergency-share-outline-rounded">
                <path d={svgPaths.p1f77d280} fill="var(--fill-0, #3FA9F5)" id="Vector" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="69" id="filter0_i_49_864" width="65" x="0" y="0">
                  ...
                  <feBlend in2="shape" mode="normal" result="effect1_innerShadow_49_864" />
                </filter>
              </defs>
            </svg>
          </div>
      ...
      <div className="absolute bg-white h-[779px] left-[40px] overflow-clip rounded-[30px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[219px] w-[299px]" data-name="Sidebar">
        ...
        <div className="absolute h-[137px] left-[16px] top-[105px] w-[257px]" data-name="Card">
          <div className="absolute bg-white border border-[rgba(81,81,81,0.5)] border-solid h-[137px] left-0 rounded-[20px] top-0 w-[257px]" />
        ...
        <Card text="Ground Unit" text1="4 Crew Members" text2="0 Lives Rescued" text3="1h Deployed" text4="#SARU-076432" additionalClassNames="h-[137px] top-[265px]" />
        <Card text="Ground Unit" text1="4 Crew Members" text2="0 Lives Rescued" text3="1h Deployed" text4="#SARU-764532" additionalClassNames="h-[135px] top-[425px]" />
