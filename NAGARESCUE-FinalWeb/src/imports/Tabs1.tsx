function EvacCenterTabs() {
  return (
    <div className="absolute h-[25px] left-[16px] top-0 w-[174px]" data-name="EVAC CENTER TABS">
      <div className="absolute flex flex-col font-['Josefin_Sans:Bold',sans-serif] font-bold justify-center leading-[0] left-0 text-[15px] text-black text-nowrap top-[12.5px] tracking-[2.55px] translate-y-[-50%]">
...
function RescueOpTabs() {
  return (
    <div className="absolute h-[25px] left-[242px] top-0 w-[174px]" data-name="RESCUE OP TABS">
      <div className="absolute flex flex-col font-['Josefin_Sans:Bold',sans-serif] font-bold justify-center leading-[0] left-0 text-[15px] text-black text-nowrap top-[12.5px] tracking-[2.55px] translate-y-[-50%]">
...
function ApprovalTabs() {
  return (
    <div className="absolute border-[#2f7fb8] border-[0px_0px_3px] border-solid h-[25px] left-[460px] top-0 w-[71px]" data-name="APPROVAL TABS">
      <div className="absolute flex flex-col font-['Josefin_Sans:Bold',sans-serif] font-bold justify-center leading-[0] left-0 text-[#2f7fb8] text-[15px] text-nowrap top-[12.5px] tracking-[2.55px] translate-y-[-50%]">
        <p className="leading-[25px]">Rescuer</p>
      </div>
    </div>
  );
}

function ApprovalTabs1() {
  return (
    <div className="absolute h-[25px] left-[575px] top-0 w-[71px]" data-name="APPROVAL TABS">
      <div className="absolute flex flex-col font-['Josefin_Sans:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[15px] text-black text-nowrap top-[12.5px] tracking-[2.55px] translate-y-[-50%]">
        <p className="leading-[25px]">Unit</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex font-['Josefin_Sans:Bold',sans-serif] font-bold gap-[75px] items-center leading-[0] pl-[53px] pr-[31px] py-[10px] relative text-[15px] text-black tracking-[2.55px] w-full">
          ...
          <div className="flex flex-col justify-center relative shrink-0 text-nowrap">
            <p className="leading-[25px]">Individual</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame17() {
  return (
    <div className="h-[45px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[#163b56] border-[0px_0px_0.5px] border-solid inset-[0_0_-0.5px_0] pointer-events-none" />
      <div className="content-stretch flex font-['Josefin_Sans:Bold',sans-serif] font-bold gap-[25px] items-start leading-[0] px-[25px] py-[10px] relative size-full text-[12px] text-black tracking-[2.04px]">
        <div className="flex flex-col justify-center relative shrink-0 w-[137px]">
          <p className="leading-[25px]">Team</p>
        </div>
        <div className="flex flex-col justify-center relative shrink-0 w-[176px]">
          <p className="leading-[25px]">Name</p>
        </div>
        <div className="flex flex-col justify-center relative shrink-0 w-[187px]">
          <p className="leading-[25px]">Date Created</p>
        </div>
        <div className="flex flex-col justify-center relative shrink-0 w-[159px]">
          <p className="leading-[25px]">Position</p>
        </div>
        ...
        <div className="flex flex-col justify-center relative shrink-0 w-[152px]">
          <p className="leading-[25px]">Contact No.</p>
        </div>
      </div>
    </div>
  );
...
function UserApproval1() {
  return (
    <div className="h-[42px] leading-[0] relative shrink-0 text-[15px] text-black tracking-[2.55px] w-full" data-name="USER APPROVAL">
      <div className="absolute flex flex-col font-['Josefin_Sans:Bold',sans-serif] font-bold justify-center left-[25px] text-nowrap top-[22.5px] translate-y-[-50%]">
        <p className="leading-[25px]">Team 001</p>
      </div>
      <div className="absolute flex flex-col font-['Josefin_Sans:Regular',sans-serif] font-normal justify-center left-[189px] top-[22.5px] translate-y-[-50%] w-[152px]">
        <p className="leading-[25px]">Daryl Adrian</p>
      </div>
      <div className="absolute flex flex-col font-['Josefin_Sans:Regular',sans-serif] font-normal justify-center left-[392px] top-[22.5px] translate-y-[-50%] w-[115px]">
        <p className="leading-[25px]">08/08/25</p>
      </div>
      <div className="absolute flex flex-col font-['Josefin_Sans:Regular',sans-serif] font-normal justify-center left-[602px] text-nowrap top-[19.5px] translate-y-[-50%]">
        <p className="leading-[25px]">Head</p>
      </div>
      <div className="absolute flex flex-col font-['Josefin_Sans:Regular',sans-serif] font-normal justify-center left-[789px] top-[22.5px] translate-y-[-50%] w-[145px]">
        <p className="leading-[25px]">CC 12345678</p>
      </div>
      <div className="absolute flex flex-col font-['Josefin_Sans:Regular',sans-serif] font-normal justify-center left-[1023px] top-[22.5px] translate-y-[-50%] w-[145px]">
        <p className="leading-[25px]">CC 12345678</p>
      </div>
    </div>
  );
...
function Frame18() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[3911px] top-0 w-[1188px]">
      <Frame17 />
...
function Component1Tab() {
  return (
    <div className="absolute h-[601px] left-[-2601px] top-[89px] w-[1198px]" data-name="1TAB">
      <EcData />
      <ReportsRescue />
      <UserApprovalList />
      <Frame18 />
...
export default function Tabs() {
  return (
    <div className="relative size-full" data-name="TABS1">
      <div className="absolute h-0 left-[2px] top-[36px] w-[1196.01px]">
        <div className="absolute inset-[-0.5px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1196.01 0.5">
            <line id="Line 18" opacity="0.5" stroke="var(--stroke-0, #163B56)" strokeWidth="0.5" x2="1196.01" y1="0.25" y2="0.25" />
          </svg>
        </div>
      </div>
      <EvacCenterTabs />
