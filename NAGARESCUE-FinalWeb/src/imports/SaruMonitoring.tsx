import svgPaths from "./svg-l5sbx5fnbr";
  ...
  return (
    <div className="absolute left-[93px] size-[65px] top-[20px]" data-name="material-symbols:emergency-share-outline-rounded">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 65 65">
        <g filter="url(#filter0_i_10_3524)" id="material-symbols:emergency-share-outline-rounded">
          <path d={svgPaths.p1f77d280} fill="var(--fill-0, #3FA9F5)" id="Vector" />
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="69" id="filter0_i_10_3524" width="65" x="0" y="0">
            ...
            <feBlend in2="shape" mode="normal" result="effect1_innerShadow_10_3524" />
          </filter>
        </defs>
      </svg>
    </div>
