  ...
  return (
    <div className="relative flex-shrink-0 h-[145px] w-full bg-[#dae7f8] rounded-[10px] pt-[16px] pb-[16px] pl-[24px] pr-[20px] flex gap-[16px]">
      ...
      <div className="flex flex-col items-center justify-center w-[100px] flex-shrink-0 gap-[6px]">
        <div
          className={`font-['Poppins',sans-serif] font-regular ${textColor} text-[30px] leading-[40px] text-center`}
        >
          {type}
        </div>
      ...
      <div className="flex-1 flex flex-col justify-between min-w-0 pt-[4px]">
        {/* Text Content */}
        <div className="flex flex-col gap-[10px]">
          <div className="font-['Poppins',sans-serif] font-regular text-[15px] leading-[20px] tracking-[0.5px] text-black">
            {area}
          </div>
        ...
        <div className="flex justify-start pb-[2px]">
          <button className="bg-[#0b5ed0] h-[28px] px-[18px] rounded-[5px] shadow-[0px_3px_8.4px_0px_rgba(0,0,0,0.25)] hover:bg-[#094a9e] transition-colors cursor-pointer flex items-center justify-center">
            <span className="font-['Poppins',sans-serif] text-[10px] text-black tracking-[0.8px] leading-[16px] whitespace-nowrap">
              VIEW LOCATION
            </span>
          </button>
        </div>
...
export default function BarangayEwsMonitoring({
  ...
  return (
    <div className="relative w-full h-screen bg-white overflow-hidden">
      ...
      <Navbar userRole="cdrrmo" activeTab="barangay" onNavigate={onNavigate} onLogout={onLogout} />
      ...
      <div className="relative z-10 flex gap-4 px-[30px] pt-[30px] pb-[30px] h-[calc(100vh-80px)]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="relative w-full h-full rounded-[10px] m-[30px]">
            ...
            {/* Custom Zoom Controls - Upper Right */}
            <div className="absolute top-[10px] right-[10px] z-30 flex flex-col gap-[2px]">
              <button
                onClick={() => setZoomLevel(prev => Math.min(prev + 1, 18))}
                className="bg-white w-[30px] h-[30px] flex items-center justify-center rounded-[4px] shadow-md hover:bg-gray-100 border border-gray-300 transition-colors"
                title="Zoom in"
              >
                <span className="font-['Poppins',sans-serif] text-[18px] font-bold text-gray-700">+</span>
              </button>
              <button
        ...
        <div className="absolute left-[30px] top-[58px] bottom-[30px] bg-white rounded-[10px] shadow-[1px_4px_11.5px_0px_rgba(0,0,0,0.25)] w-[440px] flex flex-col pointer-events-auto z-20">
          <div className="bg-[#dae7f8] flex items-center justify-center gap-[12px] h-[60px] px-[20px] py-[8px] rounded-t-[10px]">
            <svg
            ...
            <div className="flex-1 font-['Poppins',sans-serif] font-medium text-[15px] text-black tracking-[2px]">
              {barangayFilter}
            </div>
            <button
              onClick={() =>
          ...
          <div className="border-[3px] border-[#dae7f8] border-t-0 rounded-b-[10px] p-[14px] flex flex-col flex-1 overflow-y-auto gap-[10px]">
