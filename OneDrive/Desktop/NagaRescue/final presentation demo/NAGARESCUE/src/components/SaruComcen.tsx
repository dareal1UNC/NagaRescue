...
export default function SaruComcen({ onNavigate, onLogout }: SaruComcenProps) {
            ...
            {saruUnits.map((unit, index) => (
              ...
              >
                ...
                <div 
                  ...
                  style={{ 
                    backgroundColor: unit.status === "ACTIVE" ? "#d4f4dd" : unit.status === "STANDBY" ? "#fff4d4" : "#ffdddd",
                    color: unit.status === "ACTIVE" ? "#193B11" : "#FFA500"
                  }}
                >
                  {unit.status}
                </div>
        ...
        <div className="flex-1 flex flex-col gap-[20px] min-w-0">
          ...
          <div className="bg-white/80 border border-[rgba(103,103,103,0.3)] rounded-[30px] p-[24px]">
            <div className="flex items-center gap-4 mb-[24px]">
              ...
              <div>
                <div className="font-['Poppins',sans-serif] text-[28px] text-black leading-[28px] font-bold font-normal">#{unit.id}</div>
