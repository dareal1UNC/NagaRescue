import svgPaths from "./svg-rjgxnjss14";
...
import imgSaru from "figma:asset/b8d5a36a1d7d52967f5e054ab644c0094ca5b269.png";
type Wrapper4Props = {
...
function Wrapper3({ children, additionalClassNames = "" }: React.PropsWithChildren<Wrapper3Props>) {
  return (
    <div className={clsx("absolute left-[23px] size-[17px]", additionalClassNames)}>
...
function Wrapper2({ children, additionalClassNames = "" }: React.PropsWithChildren<Wrapper2Props>) {
  return (
    <div className={clsx("absolute size-[35px] top-[15px]", additionalClassNames)}>
...
function Wrapper({ children, additionalClassNames = "" }: React.PropsWithChildren<WrapperProps>) {
  return (
    <Wrapper1 additionalClassNames={clsx("absolute size-[25px]", additionalClassNames)}>
      <g id="MAP">{children}</g>
    </Wrapper1>
  );
}
...
function Equipment({ text, text1, text2, text3, text4, text5, additionalClassNames = "" }: EquipmentProps) {
  return (
    <div className={clsx("absolute content-stretch flex flex-col font-['Josefin_Sans:Medium',sans-serif] font-medium gap-[6px] items-start leading-[0] text-[#163b56] text-[20px] top-[721px]", additionalClassNames)}>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[25px]">{text}</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[25px]">{text1}</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[25px]">{text2}</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[25px]">{text3}</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[25px]">{text4}</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[25px]">{text5}</p>
      </div>
    </div>
  );
}
...
function VanUtility() {
  return (
    <Wrapper2 additionalClassNames="left-[14px]">
      <g id="van-utility 1">
...
function AccountGroup() {
  return (
    <Wrapper3 additionalClassNames="top-[57px]">
...
function ClockTimeEightOutline() {
  return (
    <Wrapper3 additionalClassNames="top-[103px]">
...
function HeartOutline() {
  return (
    <Wrapper3 additionalClassNames="top-[80px]">
...
function Add({ additionalClassNames = "" }: AddProps) {
  return (
    <div className={clsx("absolute size-[51px]", additionalClassNames)}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 51 51">
        <g id="add 2">
          <path d={svgPaths.p3506e200} fill="var(--fill-0, #5FC9F3)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
export default function Saru() {
  return (
    <div className="relative size-full" data-name="SARU">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <div className="absolute bg-white inset-0" />
        <img alt="" className="absolute max-w-none object-50%-50% object-cover opacity-50 size-full" src={imgSaru} />
      </div>
      ...
      <div className="absolute flex flex-col font-['Poppins:SemiBold',sans-serif] justify-center leading-[0] left-[189.5px] not-italic text-[45px] text-black text-center text-nowrap top-[190px] translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[50px]">S.A.R.U LIST</p>
      </div>
      <div className="absolute h-[194px] left-[384px] top-[167px] w-[1008px]" data-name="Rescue Details">
        ...
        <div className="absolute h-[86px] left-[34px] top-[86px] w-[218px]" data-name="Card 1">
          <div className="absolute bg-[#eee] h-[86px] left-0 rounded-[20px] top-0 w-[220px]" />
          <Wrapper4 additionalClassNames="absolute left-[13px] top-[8px]">
          ...
          <div className="absolute flex flex-col font-['Poppins:Bold',sans-serif] h-[28px] justify-center leading-[0] left-[15px] not-italic text-[20px] text-black top-[53px] translate-y-[-50%] w-[191px]">
            <p className="leading-[8px]">Active Mission</p>
          </div>
        </div>
        <div className="absolute h-[86px] left-[277px] top-[86px] w-[218px]" data-name="Card 2">
          <div className="absolute bg-[#eee] h-[86px] left-0 rounded-[20px] top-0 w-[220px]" />
          ...
          <div className="absolute flex flex-col font-['Poppins:Bold',sans-serif] h-[28px] justify-center leading-[0] left-[15px] not-italic text-[20px] text-black top-[53px] translate-y-[-50%] w-[155px]">
            <p className="leading-[8px]">5 Members</p>
          </div>
          <Wrapper4 additionalClassNames="absolute left-[15px] top-[6px]">
            <g id="account-group 1">
              <path d={svgPaths.p33a9dd00} fill="var(--fill-0, #5FC9F3)" id="Vector" />
            </g>
          </Wrapper4>
        </div>
        <div className="absolute h-[86px] left-[520px] top-[86px] w-[218px]" data-name="Card 3">
          <div className="absolute bg-[#eee] h-[86px] left-0 rounded-[20px] top-0 w-[220px]" />
          ...
          <div className="absolute flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] left-[15px] not-italic text-[20px] text-black text-nowrap top-[53px] translate-y-[-50%]">
            <p className="leading-[8px]">5 People Rescued</p>
          </div>
          <Wrapper4 additionalClassNames="absolute left-[15px] top-[7px]">
            <g id="heart-outline 1">
              <path d={svgPaths.p60bd380} fill="var(--fill-0, #FE4848)" id="Vector" />
            </g>
          </Wrapper4>
        </div>
        <div className="absolute h-[86px] left-[763px] top-[86px] w-[218px]" data-name="Card 4">
          <div className="absolute bg-[#eee] h-[86px] left-0 rounded-[20px] top-0 w-[220px]" />
          <div className="absolute flex flex-col font-['Poppins:Regular',sans-serif] h-[20px] justify-center leading-[0] left-[42px] not-italic text-[14px] text-black top-[19px] translate-y-[-50%] w-[128px]">
          ...
          <Wrapper4 additionalClassNames="absolute left-[12px] top-[5px]">
            <g id="clock-time-eight-outline 1">
      ...
      <div className="absolute contents left-[384px] top-[376px]" data-name="OPERATIONS">
        ...
        <div className="absolute contents left-[410px] top-[423px]">
          <div className="absolute bg-white border border-[#8c000f] border-solid h-[412px] left-[410px] overflow-clip rounded-[15px] top-[423px] w-[534px]" data-name="Details Info 2" />
          <p className="absolute font-['Poppins:Regular',sans-serif] leading-[15px] left-[933px] not-italic text-[#676767] text-[14px] text-nowrap text-right top-[444px] translate-x-[-100%]">12m ago</p>
          <div className="absolute h-[220px] left-[502px] overflow-clip rounded-[30px] top-[601px] w-[413px]" data-name="map">
            ...
            <Map additionalClassNames="left-[618px] top-[333px]" />
          ...
          <div className="absolute font-['Poppins:Regular',sans-serif] h-[15px] leading-[8px] left-[510px] not-italic text-[16px] text-black top-[463px] w-[375px]">
            <p className="mb-0">{`Total members:  15`}</p>
            <p>&nbsp;</p>
          </div>
          <div className="absolute font-['Poppins:Regular',sans-serif] h-[31px] leading-[8px] left-[510px] not-italic text-[0px] text-[16px] text-black top-[494px] w-[381px]">
            ...
            <p className="mb-0">&nbsp;</p>
            <p className="mb-0">{`                 Zone 6, San Felipe, Naga City`}</p>
            <p>&nbsp;</p>
          </div>
        ...
        <div className="absolute contents left-[410px] top-[882px]">
          <div className="absolute bg-white border border-[#8c000f] border-solid h-[86px] left-[410px] overflow-clip rounded-[15px] top-[882px] w-[534px]" data-name="Details Info 2" />
          ...
          <div className="absolute font-['Poppins:Regular',sans-serif] h-[15px] leading-[8px] left-[510px] not-italic text-[0px] text-[16px] text-black top-[953px] w-[381px]">
            <p className="mb-0">
              <span className="text-[#515151]">Address:</span>
              <span>{` 6th Street, Cokeville  `}</span>
            </p>
          ...
          <p className="absolute font-['Poppins:Regular',sans-serif] leading-[8px] left-[937px] not-italic text-[#676767] text-[14px] text-nowrap text-right top-[902px] translate-x-[-100%]">20m ago</p>
        </div>
      </div>
      <div className="absolute contents left-[1032px] top-[375.84px]" data-name="Crew and Equipment">
        ...
        <div className="absolute flex flex-col font-['Josefin_Sans:Bold',sans-serif] font-bold h-[29.816px] justify-center leading-[0] left-[1062px] text-[25px] text-black top-[692.91px] translate-y-[-50%] w-[150px]">
          <p className="leading-[35px]">Equipment</p>
        </div>
        <Add additionalClassNames="left-[1321px] top-[618px]" />
      </div>
      <div className="absolute bg-white h-[100px] left-0 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.1)] top-0 w-[1440px]" data-name="NAVBAR COMCEN">
        <div className="absolute contents left-[93px] top-[20px]" data-name="BADGE">
          <div className="absolute left-[93px] size-[65px] top-[20px]" data-name="material-symbols:emergency-share-outline-rounded">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 65 65">
              <g filter="url(#filter0_i_61_1476)" id="material-symbols:emergency-share-outline-rounded">
                <path d={svgPaths.p1f77d280} fill="var(--fill-0, #3FA9F5)" id="Vector" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="69" id="filter0_i_61_1476" width="65" x="0" y="0">
                  ...
                  <feBlend in2="shape" mode="normal" result="effect1_innerShadow_61_1476" />
                </filter>
              </defs>
            </svg>
          </div>
        ...
        <div className="absolute content-stretch flex gap-[35px] items-center justify-end left-[770px] top-1/2 translate-y-[-50%]" data-name="NAVBARS">
          ...
          <div className="bg-[#3fa9f5] content-stretch flex gap-[7px] items-center p-[10px] relative rounded-[5px] shrink-0" data-name="SARU">
            <Wrapper1 additionalClassNames="relative shrink-0 size-[25px]">
              <g clipPath="url(#clip0_61_1448)" id="streamline:medical-bag-remix">
                <path clipRule="evenodd" d={svgPaths.p249e8920} fill="var(--fill-0, #163B56)" fillRule="evenodd" id="Vector" />
              </g>
              <defs>
                <clipPath id="clip0_61_1448">
          ...
          <div className="content-stretch flex gap-[10px] h-[30px] items-center p-[5px] relative shrink-0 w-[135px]" data-name="REPORTS">
            ...
            <div className="overflow-clip relative shrink-0 size-[24px]" data-name="mingcute:documents-line">
              <div className="absolute inset-[8.33%_12.5%_0.77%_16.67%]" data-name="Group">
      ...
      <div className="absolute bg-white h-[779px] left-[40px] overflow-clip rounded-[30px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[219px] w-[299px]" data-name="Sidebar">
        ...
        <div className="absolute h-[26px] left-[22px] top-[57px] w-[226px]" data-name="Search bar">
          <div className="absolute bg-white border-[0.5px] border-[rgba(81,81,81,0.5)] border-solid h-[26px] left-[-3px] rounded-[9px] top-0 w-[229px]" />
        ...
        <div className="absolute h-[137px] left-[23px] top-[110px] w-[257px]" data-name="Card">
          ...
          <Ferry />
          <p className="absolute font-['Poppins:Regular',sans-serif] h-[9px] leading-[8px] left-[65px] not-italic text-[10px] text-black top-[40px] w-[136px]">Boat Unit</p>
          ...
          <p className="absolute font-['Poppins:Regular',sans-serif] leading-[8px] left-[49px] not-italic text-[14px] text-black text-nowrap top-[107px]">2h 30m Deployed</p>
          <HeartOutline />
        ...
        <div className="absolute h-[137px] left-[21px] top-[602px] w-[257px]" data-name="Card">
          <div className="absolute bg-white border border-[rgba(81,81,81,0.5)] border-solid h-[137px] left-0 rounded-[20px] top-0 w-[257px]" />
          <VanUtility />
          <p className="absolute font-['Poppins:Regular',sans-serif] h-[9px] leading-[8px] left-[65px] not-italic text-[10px] text-black top-[40px] w-[136px]">Ground Unit</p>
        ...
        <Wrapper4 additionalClassNames="absolute left-[256px] top-[58px]">
          <g id="filter-variant (1) 1">
            <path d={svgPaths.p3a53e1f0} fill="var(--fill-0, #676767)" id="Vector" />
          </g>
        </Wrapper4>
      </div>
      <div className="absolute h-[154.46px] left-[1062px] top-[437px] w-[309px]" data-name="CREW MEMBER">
        <div className="absolute flex flex-col font-['Josefin_Sans:Bold',sans-serif] font-bold justify-center leading-[0] left-0 text-[25px] text-black text-nowrap top-[12.5px] translate-y-[-50%]">
          <p className="leading-[25px]">Crew Members</p>
        </div>
      ...
      <Equipment text="Portable Boat" text1="Rope" text2="Chainsaw" text3="Medic Kit" text4="Entonox" text5="Rigging System" additionalClassNames="left-[1073px] w-[156px]" />
      <Equipment text="2" text1="5" text2="2" text3="4" text4="2" text5="1" additionalClassNames="left-[1243px] w-[116px]" />
      <div className="absolute h-[39px] left-[1334px] top-[932px] w-[38px]" data-name="edit 1">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38 39">
          <g id="edit 1">
            <path d={svgPaths.p165a51c0} fill="var(--fill-0, #5FC9F3)" id="Vector" />
          </g>
        </svg>
      </div>
      <Add additionalClassNames="left-[1268px] top-[926px]" />
    </div>
  );
}