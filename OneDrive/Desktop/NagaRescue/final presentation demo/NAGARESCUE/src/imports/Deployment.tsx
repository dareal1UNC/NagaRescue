    ...
    <div className="bg-white relative size-full" data-name="DEPLOYMENT">
      <div className="absolute h-[924px] left-0 overflow-clip rounded-[30px] top-[100px] w-[1440px]" data-name="map">
        ...
        <div className="absolute h-[842px] left-[40px] overflow-clip top-[41px] w-[433px]" data-name="MONITOR">
          ...
          <div className="absolute content-stretch flex flex-col gap-[17px] items-center left-[17px] overflow-clip top-[147px] w-[399px]">
            <DropdownVictimsRed2 additionalClassNames="h-[250px]">
              <Helper text="Sep. 23, 2025" text1="2:15 PM" />
              <Details text="#H-123456" text1="&nbsp;" text2="Address:" text3="&nbsp;" text4="To Consider:" additionalClassNames="left-[72px]" />
              <p className="absolute font-['Poppins:Regular',sans-serif] leading-[8px] left-[366px] not-italic text-[#676767] text-[14px] text-nowrap text-right top-[13px] translate-x-[-100%]">2m ago</p>
              <PendingText text="Pending" />
              ...
              <div className="absolute h-0 left-[19px] top-[101px] w-[348.006px]">
                <div className="absolute inset-[-1px_0_0_0]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 348 1">
                    <line id="Line 1" stroke="var(--stroke-0, black)" strokeOpacity="0.05" x2="348.006" y1="0.5" y2="0.5" />
                  </svg>
                </div>
              </div>
              <div className="absolute content-stretch flex flex-col gap-[3px] items-start left-[24px] top-[116px] w-[341px]" data-name="more details">
                <div className="content-stretch flex gap-[15px] items-end leading-[8px] not-italic relative shrink-0 text-black text-nowrap w-full">
                  ...
                  <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[12px]">Gender</p>
                  <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[6px]">Special Needs / Medical Condition</p>
                </div>
                <div className="h-0 relative shrink-0 w-[341.001px]">
                  <div className="absolute inset-[-0.1px_0]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 341 1">
                      <path d="M0 0.1H341.001" id="Line 2" stroke="var(--stroke-0, black)" strokeOpacity="0.3" strokeWidth="0.2" />
                    </svg>
                  </div>
                </div>
                {[...Array(3).keys()].map((_, i) => (
                  <div className="content-stretch flex font-['Poppins:Regular',sans-serif] items-center leading-[8px] not-italic relative shrink-0 text-[10px] text-black">
                    <p className="relative shrink-0 w-[137px]">Rachelle Abada</p>
                    <p className="h-[9px] relative shrink-0 w-[39px]">25</p>
                    <p className="relative shrink-0 w-[72px]">Female</p>
                    <p className="relative shrink-0 text-center w-[63.697px]">None</p>
                  </div>
                ))}
              </div>
              <Text text="DEPLOY UNIT" additionalClassNames="bg-[#cdeefb] border-[#5fc9f3] left-[19px]" />
              <Text text="ABANDON" additionalClassNames="bg-[rgba(255,255,255,0.1)] border-[rgba(0,0,0,0.25)] left-[112px]" />
            </DropdownVictimsRed2>
            <DropdownVictimsRed />
            <DropdownVictimsRed1 />
            <DropdownVictimsRed />
            <DropdownVictimsRed1 />
            <div className="bg-white h-[100px] relative rounded-[15px] shrink-0 w-full" data-name="DROPDOWN VICTIMS RED">
              <div className="overflow-clip relative rounded-[inherit] size-full">
                <Helper text="Sep. 23, 2025" text1="2:15 PM" />
                <Details text="#H-123456" text1="&nbsp;" text2="Address:" text3="&nbsp;" text4="To Consider:" additionalClassNames="left-[73px]" />
                <p className="absolute font-['Poppins:Regular',sans-serif] leading-[8px] left-[366px] not-italic text-[#676767] text-[14px] text-nowrap text-right top-[13px] translate-x-[-100%]">2m ago</p>
                <PendingText text="Pending" />
                <div className="absolute flex items-center justify-center left-[352px] size-[15px] top-[59px]">
                  <div className="flex-none rotate-[180deg]">
              ...
              <div aria-hidden="true" className="absolute border border-[#8c000f] border-solid inset-0 pointer-events-none rounded-[15px]" />
            </div>
          </div>
        </div>
